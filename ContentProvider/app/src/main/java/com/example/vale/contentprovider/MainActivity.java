...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cursor.moveToFirst()){
            Log.d(getClass().getCanonicalName(), "La consulta ha recuperado = " + cursor.getCount());
            long id_contacto = -1;
            do{
                id_contacto = cursor.getLong(cursor.getColumnIndex(ContactsContract.Contacts._ID));
                Log.d(getClass().getCanonicalName(), "ID recuperado = " + id_contacto);
